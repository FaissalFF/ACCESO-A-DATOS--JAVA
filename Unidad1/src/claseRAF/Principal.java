...
public class Principal {
	...
	public static proyectoFicherosB.Modelo adAsig = new proyectoFicherosB.Modelo("asignaturas.bin");

	// DEclaramos un acceso a datos de la clase fichero texto - Alumnos
	public static ProyectoFicherosN2.Modelo adAlumnos = new ProyectoFicherosN2.Modelo("alumnos.txt");
	...
	public static void mostrarNotasAlumno() {
		// Mostrar alumnos
		ArrayList<Alumno> alumnos = adAlumnos.mostrarAlumnos();
	...
	private static void altaNota() {
		...
		try {
			...
			Alumno al = adAlumnos.mostrarAlumnoconDni(t.nextLine());
			if (al != null) {
				// Mostrar y comprobar asignaturas
				ArrayList<Asignatura> asigs = adAsig.mostrarAsigs();
